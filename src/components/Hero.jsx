...
const Hero =()=>{
    return(
        <div className="text-white">
            <div className="max-w-[800px] w-full mt-4 h-screen mx-auto text-center flex flex-col">
            <p className="text-[#00df9a] md:text-7xl sm:text-6xl text-4xl font-bold p-2">
                ...
                <img className="rounded-full sm:w-[500px] w-[300px] mx-auto" src={ProfilePicture} alt="" />
